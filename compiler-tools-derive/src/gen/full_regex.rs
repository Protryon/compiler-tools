...
use crate::{TokenParseData, construct_variant, flatten};

pub(crate) fn gen_full_regex(tokens_to_parse: &[TokenParseData], conflicts: &BTreeMap<(Ident, String), Vec<(Ident, String)>>, enum_ident: &Ident) -> Result<(TokenStream, TokenStream), TokenStream> {
