...
use super::{Repeat, Atom, GroupEntry, SimpleRegexAst};
        ...
        for atom in &from.atoms {
            ...
            match atom.repeat {
                ...
                Repeat::ZeroOrOnce => {
                    ...
                    self_.transitions.insert(current_state, vec![(first_event, current_state + 1), (TransitionEvent::Epsilon, current_state + events.len() as u32 + 1)]);
                    current_state += 1;
                ...
                Repeat::OnceOrMore => {
                    ...
                    self_.transitions.insert(current_state, vec![(first_event, next_state), (TransitionEvent::Epsilon, current_state + events.len() as u32 + 1)]);
                    current_state += 1;
